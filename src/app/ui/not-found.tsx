...
export default function NotFoundPage({children}:{children:ReactNode}){
    return (
        <div
            className="grid h-full w-full place-content-center px-4 bg-lightShades-100 dark:bg-darkShades-100 dark:text-darkShades-100">
            <div className="text-center">
                ...
                <p className="mt-4 text-darkShades-300 dark:text-lightShades-300">{children}</p>
